...
//            ->notEmptyDateTime('nonce_expiry');
        ...
        // Making nonce optional
        $validator
            ->scalar('nonce')
            ->maxLength('nonce', 255)
            ->allowEmptyString('nonce');  // Makes nonce optional

        // Making nonce_expiry optional
        $validator
            ->dateTime('nonce_expiry')
            ->allowEmptyDateTime('nonce_expiry');  // Makes nonce_expiry optional
        return $validator;
    }
