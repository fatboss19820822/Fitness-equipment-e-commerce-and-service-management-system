...
return [
     ...
     */
    'Recaptcha' => [
        'sitekey' => '6LcymP0qAAAAAI2i4qBv5sCO8R2r98S3P9-_fxL9', // Your Google reCAPTCHA site key
        'secret' => '6LcymP0qAAAAAPiBExR-uKs14t8xp0rGbLudpV4x',    // Your Google reCAPTCHA secret key
        'type' => 'image',            // Type: 'image' or 'audio'
        'theme' => 'light',           // Theme: 'light' or 'dark'
        'lang' => 'es',               // Language code (default 'en', change to 'es' for Spanish)
        'size' => 'normal'            // Size: 'normal' or 'compact'
    ],
