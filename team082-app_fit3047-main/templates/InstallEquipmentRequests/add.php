...
<head>
    ...
    <title>Request Equipment Installation</title>
...
<div class="contact-form">
    ...
    <h2 class="text-center mb-4"><?= __('Request Equipment Installation') ?></h2>
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                <?= $this->Form->control('email', [
                    'label' => 'Email', 'class' => 'form-control',
            ...
            <div class="mb-3">
                <?= $this->Form->control('address', [
                    ...
                    'placeholder' => 'Enter your installation address here... ',
                    'class' => 'form-control',
                    'type' => 'text', 'required' => true]) ?>
            </div>
        </div>

        <!-- Installation Equipment Details Column -->
        <div class="col-md-6">
            <div class="section-title"><?= __('Installation Equipment Details') ?></div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <?= $this->Form->control('equipment_type', [
                    'label' => 'Specific Equipment Type (e.g. treadmill)',
